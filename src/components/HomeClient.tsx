...
function HomeClient({email}:{email?:string}) {
 ...
 const features=[
  ...
  },
  {
    ...
    desc:"Your control exactly what the AI knows and answers."    
  },
  {
    title:"Always Online",
  ...
  return (
    ...
    <div className='max-w-7xl mx-auto px-20 h-16 flex items-center justify-between'>
      ...
      <section className='pt-27 pb-28 px-6'>
        <div className='max-w-6xl ml-14 mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
          <motion.div
      ...
      <p className='mt-6 text-lg md:text-xl text-zinc-600 max-w-xl'>
        Deliver instant, intelligent customer support with AI that works 24/7 — fast, scalable, and seamless for any website.
      </p>
          ...
          className='relative'
          >
          <div className='max-w-sm mx-auto rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6'>
            ...
            <div className='space-y-4'>
               <div className='bg-black text-white rounded-lg px-4 py-2 text-sm ml-auto w-fit'>
                ...
                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit'>
                  I'm here to help! 🚀 What issue are you facing with your subscription?
                </div>
                ...
                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit'>
                  No worries 👍 I’ll check that for you right away. Please hold on a moment.
                </div>
            </div>
            ...
            className='absolute -buttom-6 right-15 w-14 h-14  rounded-full bg-black text-white flex items-center justify-center shadow-xl '
            >
             💬
          </motion.div>
